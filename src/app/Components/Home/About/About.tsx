...
const About = () => {
  return (
    <div className="dark:bg-[#030C1A] pt-10 pb-16">
      <Component>
        <div className=" px mx-auto mt-20 flex items-center flex-col-reverse lg:flex-row p-10 lg:p-0 lg:justify-between items-center gap-10 lg:gap-60">
          <Image className="w-full lg:w-[576px]" src={img} alt="" />
          <div>
            <Title>About</Title>
